...
<label className={styles.label} htmlFor="place">集合場所</label>
<TextInput id="place" label="" placeholder="" />


<label className={styles.label} htmlFor="time">集合時間</label>
<TextInput id="time" type="time" label="" />


<label className={styles.label} htmlFor="keyword">あいことば</label>
